    ...
    <div class="kebidanan-header">
        ...
        <div class="kebidanan-title-area">
            ...
            <div>
                ...
                <p>
                    Data ibu hamil hasil registrasi petugas
                </p>
        ...
        <a
            href="ibu-hamil-pdf-semua.php"
            target="_blank"
            class="btn-cetak-semua">
                        ...
                        <tr class="data-ibu">
                            ...
                            <td class="text-center">
                                ...
                                <div class="aksi-wrapper">
                                    ...
                                    <a
                                        href="cetak-pemeriksaan-ibu-hamil.php?id=<?= $data['id']; ?>"
                                    ...
                                    <a
                                        ...
                                        title="Hapus"
                                        data-toggle="tooltip"
                                        onclick="return confirm('Hapus data ibu hamil <?= htmlspecialchars($data['nama_ibu']); ?>? Data pemeriksaan dan jadwal terkait juga akan terhapus.');">
                        ...
                        <tr id="dataKosong">
                            ...
                            <td
                                ...
                                <div class="empty-data-text">
                                    ...
                                    Data ibu hamil akan tampil setelah didaftarkan oleh petugas.
