...
// ======================================================
//
// Kriteria disamakan dengan halaman laporan/bpjs.php (yang tampil di
// layar): berdasarkan no_asuransi diawali "BPJS", BUKAN jenis_pembayaran.
// Sebelumnya PDF ini pakai jenis_pembayaran = 'BPJS', padahal banyak
// pasien lama kolom jenis_pembayaran-nya kosong (belum pernah diisi)
// walau no_asuransi-nya sudah BPJS -> PDF jadi kosong padahal di layar
// datanya ada.
// ======================================================
...
$pdf->Cell(0, 7, 'LAPORAN PASIEN BPJS', 0, 1, 'C');
...
$pdf->Output('I', 'Laporan-BPJS-' . ucfirst($periode) . '.pdf');